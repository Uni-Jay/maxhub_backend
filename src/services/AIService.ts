...
class AIService {
  ...
  /**
   * Generate a unique, personalised birthday message using Claude Haiku.
   * Returns plain text — the caller wraps it in HTML.
   * Falls back to a static message if the API key is not set or the call fails.
   */
