...
export enum PermissionCode {
  ...
  HR_APPRAISAL_UPDATE_ALL = 'hr.appraisal.update.all',
  HR_APPRAISAL_APPROVE_ALL = 'hr.appraisal.approve.all',

  HR_WEEKLY_REPORT_CREATE_OWN = 'hr.weeklyreport.create.own',
  HR_WEEKLY_REPORT_READ_OWN = 'hr.weeklyreport.read.own',
  HR_WEEKLY_REPORT_READ_ALL = 'hr.weeklyreport.read.all',
  ...
  STM_STUDENT_READ_OWN_DEPARTMENT = 'stm.student.read.own_department',
