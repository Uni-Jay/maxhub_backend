...
export class OrderTracking extends Model<IOrderTracking> implements IOrderTracking {
  ...
  public static initModel(sequelize: Sequelize): typeof OrderTracking {
    OrderTracking.init(
      {
        ...
        finalAmount: { type: DataTypes.DECIMAL(15, 2), allowNull: false },
        orderStatus: {
        ...
        shippingTrackingNumber: { type: DataTypes.STRING(100), allowNull: true },
