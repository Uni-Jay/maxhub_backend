...
router.get('/super-admin/attendance', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getSuperAdminAttendance);
router.get('/super-admin/revenue', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getSuperAdminRevenue);
router.get('/super-admin/payroll', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getSuperAdminPayroll);
router.get('/super-admin/departments', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getSuperAdminDepartments);
router.get('/super-admin/students', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getSuperAdminStudents);
...
router.post('/head-of-admin/leave-approvals/:leaveId/reject', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.rejectLeave);
router.get('/head-of-admin/attendance-reports', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getHeadOfAdminAttendanceReports);
router.get('/head-of-admin/department-kpis', AuthMiddleware_1.default.verifyToken, DashboardController_1.DashboardController.getHeadOfAdminDepartmentKPIs);
