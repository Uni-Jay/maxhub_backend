...
router.delete('/:id', AuthMiddleware_1.default.verifyToken, AuthMiddleware_1.default.requirePermission(PermissionCodes_1.PermissionCode.STM_STUDENT_DELETE_ALL), StudentController_1.default.remove);
