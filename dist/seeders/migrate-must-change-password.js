...
async function main() {
    ...
    const [existing] = await sequelize.query(`SELECT column_name FROM information_schema.columns WHERE table_schema='public' AND table_name = 'users' AND column_name = 'mustChangePassword'`);
...
//# sourceMappingURL=migrate-must-change-password.js.map