...
exports.ROLE_SYSTEM_PROMPTS = void 0;
exports.buildChatSystem = buildChatSystem;
exports.buildReportPrompt = buildReportPrompt;
exports.buildMeetingSummaryPrompt = buildMeetingSummaryPrompt;
exports.buildEmailPrompt = buildEmailPrompt;
exports.buildTaskSuggestionsPrompt = buildTaskSuggestionsPrompt;
exports.buildReminderPrompt = buildReminderPrompt;
const COMPANY = process.env.COMPANY_NAME || 'MaxHub';
exports.ROLE_SYSTEM_PROMPTS = {
...
function buildChatSystem(roleName, userName, businessUnit) {
    const roleContext = exports.ROLE_SYSTEM_PROMPTS[roleName] ?? exports.ROLE_SYSTEM_PROMPTS.staff;
...
function buildReportPrompt(type, data, period) {
...
function buildMeetingSummaryPrompt(title, transcript, participants) {
...
function buildEmailPrompt(type, recipient, context) {
...
function buildTaskSuggestionsPrompt(overdueTasks, pendingTasks, teamWorkload) {
...
function buildReminderPrompt(type, context) {
