...
class Invoice extends sequelize_1.Model {
    static initModel(sequelize) {
        Invoice.init({
            ...
            accountId: { type: sequelize_1.DataTypes.BIGINT.UNSIGNED, allowNull: true, comment: 'Account ID (legacy, generic)' },
            clientId: { type: sequelize_1.DataTypes.BIGINT.UNSIGNED, allowNull: true, comment: 'Client ID (CRM customer this invoice is billed to)' },
