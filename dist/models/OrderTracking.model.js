...
class OrderTracking extends sequelize_1.Model {
    static initModel(sequelize) {
        OrderTracking.init({
            ...
            customerId: { type: sequelize_1.DataTypes.BIGINT, allowNull: false },
            orderDate: { type: sequelize_1.DataTypes.DATE, allowNull: false },
            ...
            discountAmount: { type: sequelize_1.DataTypes.DECIMAL(10, 2), allowNull: true },
            taxAmount: { type: sequelize_1.DataTypes.DECIMAL(10, 2), allowNull: false },
            finalAmount: { type: sequelize_1.DataTypes.DECIMAL(15, 2), allowNull: false },
            orderStatus: {
            ...
            shippingAddress: { type: sequelize_1.DataTypes.TEXT, allowNull: true },
            ...
            shippingTrackingNumber: { type: sequelize_1.DataTypes.STRING(100), allowNull: true },
